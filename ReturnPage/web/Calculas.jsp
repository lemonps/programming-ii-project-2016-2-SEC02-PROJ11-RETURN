                                            ...
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption font-kademy">
                                                        <span class="caption-subject bold uppercase">MTH101 LATEST VIDEO</span>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mt-element-card mt-element-overlay">
                                                        <div class="row">
                                                            ...
                                                            <div id="contentMaster">
                                                                ...
                                                                <div id="content">
                                                                    <c:forEach items="${videos}" var="video" varStatus="vs" begin="0" end="1">
                                                                ...
                                                                <div id="content2">
                                                                    <c:forEach items="${videos}" var="video" varStatus="vs" begin="2" end="3">
                                                                ...
                                                                <div id="content">
                                                                    <c:forEach items="${videos}" var="video" varStatus="vs" begin="4" end="5">
                                                                ...
                                                                <div id="content2">
                                                                    <c:forEach items="${videos}" var="video" varStatus="vs" begin="6" end="7">
                                                                ...
                                                                <div id="content">
                                                                    <c:forEach items="${videos}" var="video" varStatus="vs" begin="8" end="9">
