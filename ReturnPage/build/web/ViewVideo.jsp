                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <video width="961" height="500" autoplay  >
                                                    ...
                                                    <div class="portlet light">
                                                        <div class="portlet-title">
                                                            <div class="caption font-kademy">
                                                                <span class="caption-subject bold uppercase">MTH101 CALCULUS I</span>
                                                            </div>
                                                        </div>
                                                        <div class="portlet-body">
                                                            <p class="mt-card-desc font-grey-cararra">AJ. KASEM KEETAK</p>
                                                            <p class="mt-card-desc font-grey-cararra">SEC.2 13.30-16.30</p>
                                        ...
                                        <div class="col-md-3">
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption font-kademy">
                                                        <span class="caption-subject bold uppercase"><a href="video-subject.html">More MTH101 Video</a></span>
                                                    </div>
                                                </div>
                                                <div class="portlet-body">
